...
# Component: MSRIGS Sensitivity Analysis On Loss Using Simulated Datasets (Data subjects have different strategies)
...
# choose a parameter
parameter = 5  # 0:Number of genomic attributes. 1:Missing proportion of genomic data. 2:Threshold for confidence score.
