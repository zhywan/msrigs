...
# Component: MSRIGS Sensitivity Analysis On Size of Genetic Genealogy Dataset Using Simulated Datasets
...
# April 18, 2021: Fix the randomization for better comparison.
...
# choose a parameter
parameter = 3  # 0:Number of genomic attributes. 1:Missing proportion of genomic data. 2:Threshold for confidence score.
