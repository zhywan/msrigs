...
# Component: MSRIGS Sensitivity Analysis On Size of Identified Dataset Using Simulated Datasets
...
# April 21, 2020: save the success rate
...
save_I: bool = False  # save I in each iteration (only work for scenario 0)

# choose a parameter
parameter = 4  # 0:Number of genomic attributes. 1:Missing proportion of genomic data. 2:Threshold for confidence score.
