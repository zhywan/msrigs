...
# Component: MSRIGS Sensitivity Analysis On Benefit of Sharing All Dat Using Simulated Datasets
...
# choose a parameter
parameter: int = 6  # 0:Number of genomic attributes. 1:Missing proportion of genomic data. 2:Threshold for confidence score.
...
if __name__ == '__main__':
    ...
    for i in range(n_iter):
        ...
        for m_n in range(n_m):
            total_utility = step * m_n + m_start
