...
# Component: MSRIGS Sensitivity Analysis On Threshold for Confidence Score (Theta) Using Simulated Datasets
...
# choose a parameter
parameter: int = 2  # 0:Number of genomic attributes. 1:Missing proportion of genomic data. 2:Threshold for confidence score.
