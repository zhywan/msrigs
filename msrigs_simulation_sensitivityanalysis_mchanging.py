...
# Component: MSRIGS Sensitivity Analysis On Number of Genomic Attributes (m) Using Simulated Datasets
...
# July 13, 2020: Modify one scenario, and add three new scenarios.
# July 13, 2020: Rename saved file.
# Oct 11, 2020: Using function version 21.
# Oct 13, 2020: In the inner loop, change individually, add missing values and compute entropy (with missing data).
...
# choose a parameter
parameter: int = 0  # 0:Number of genomic attributes. 1:Missing proportion of genomic data. 2:Threshold for confidence score.
...
if __name__ == '__main__':
    ...
    for i in range(n_iter):
        ...
        for m_n in range(n_m):
            ...
            custom_strategy_filename = folder_result + custom_strategy_folder + 'i' + str(i) + '_mg' + str(m_g) + '.csv'
